...
| --- | --- | --- |
| OpenAI-compatible | `https://api-direct.dimilinks.com/v1` | GPT, other compatible models, and Claude through the OpenAI protocol |
...
- **Entered `https://api-direct.dimilinks.com/` without `/v1`:** OpenAI-compatible clients return `404`; append `/v1`.
