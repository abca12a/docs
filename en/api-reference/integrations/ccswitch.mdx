...
Every request uses `api-direct.dimilinks.com`. One-click import writes the correct form with or without `/v1`, depending on whether the target client appends the API path automatically.
...
| Other (GPT / unrestricted) | OpenAI style | `https://api-direct.dimilinks.com/v1` |
...
| `endpoint` | Base URL for the target tool: `https://api-direct.dimilinks.com/v1` or `https://api-direct.dimilinks.com`, without a trailing slash |
